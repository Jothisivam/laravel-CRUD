...
<div class="container mt-2">
    <div class="row my-3">
        <div class="border-bottom">
            <h5><i class="bi bi-journal-richtext"></i>Add New Product</h5>
        </div>
        ...
        <div class="col-lg-8">
            <form action="/products/store" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Enter email" value="{{old('name')}}">
                            @error('name')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('mrp') is-invalid @enderror" name="mrp" id="mrp" placeholder="Enter M.R.P" value="{{old('mrp')}}">
                            @error('mrp')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-dark btn-md" id="btnsubmit">Save Product</button>
